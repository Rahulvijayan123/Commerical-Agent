            ...
            <CardContent className="p-4 text-center">
              <div className="flex items-center justify-center gap-2">
                ...
                <ExpandableDetail
                  ...
                  value={metric.value}
                  assumptions={
                    metric.metric === "Peak Revenue"
                      ? [
                          "Peak achieved in year 4 (2030) based on TKI launch curves",
                          "US represents 60% of global revenue at $200K pricing",
                          "Ex-US pricing at $130K with 40% market share",
                          "Gross-to-net of 35% at peak, increasing to 40% by LOE",
                        ]
                      : metric.metric === "Total 10-Year Revenue"
                        ? [
                            "Launch in 2027 following Phase III completion",
                            "Patent expiry 2033 with 65% generic erosion by 2035",
                            "Currency exchange rates held constant at 2024 levels",
                            "No major indication expansions beyond NSCLC",
                          ]
                        : [
                            "Risk-adjusted using Monte Carlo simulation (10K iterations)",
                            "Development risk: 75% Phase III success probability",
                            "Commercial risk: 85% launch success probability",
                            "Competitive risk: 25% market share erosion from new entrants",
                          ]
                  }
                  formula={
                    metric.metric === "Peak Revenue"
                      ? "Peak Revenue = (Patient Population × Market Share × Price × Persistence) - Rebates"
                      : metric.metric === "ANPV"
                        ? "ANPV = Σ(Annual Cash Flow / (1 + Discount Rate)^Year) × Risk Adjustment"
                        : "Metric = Base Case × Risk Factors × Market Dynamics"
                  }
                  sources={financialSources}
                  aiDerivation="Generated using ensemble modeling of 25 comparable oncology launches, weighted by MoA similarity and market dynamics"
                />
              </div>
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <ExpandableDetail
                title="LOE Impact Analysis"
                value="65"
                unit="% revenue loss"
                assumptions={[
                  "Generic entry begins 6 months after patent expiry (2033)",
                  "First year generic penetration: 35% based on oncology benchmarks",
                  "Branded price erosion: 15% in year 1, 25% by year 3",
                  "Authorized generic strategy not assumed in base case",
                ]}
                formula="Revenue Loss = (Generic Market Share × Price Erosion) + (Branded Share × Price Decline)"
                sources={[
                  { name: "IQVIA Generic Impact Database", type: "database" },
                  { name: "Oncology LOE Analysis", type: "manual" },
                  { name: "Generic Competition Modeling", type: "ai-generated" },
                ]}
              />
            </div>
          </CardHeader>
          ...
          <div className="mt-6 p-4 bg-slate-50 rounded-lg">
            <div className="flex items-center justify-between mb-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <ExpandableDetail
                  title="Licensing Power Index"
                  value="78"
                  unit="/100"
                  assumptions={[
                    "Pricing leverage (85/100): Premium pricing supported by differentiation",
                    "Exclusivity window (72/100): 6-year core patent protection",
                    "Payer alignment (78/100): Strong health economic profile",
                    "Competitive position (82/100): Limited direct competition",
                  ]}
                  formula="LPI = (Pricing × 0.3) + (Exclusivity × 0.25) + (Payer × 0.25) + (Competition × 0.2)"
                  sources={[
                    { name: "Licensing Deal Database", type: "database" },
                    { name: "Pharma Valuation Multiples", type: "database" },
                    { name: "Strategic Assessment", type: "manual" },
                  ]}
                />
              </div>
            </div>
