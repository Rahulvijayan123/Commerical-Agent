  ...
  return (
    <div className="space-y-6">
        ...
        <CardContent>
          <div className="grid grid-cols-3 gap-4">
            <div className="text-center">
              ...
              <p className="text-sm text-slate-600">Exclusivity Years</p>
            </div>
            <div className="text-center">
      ...
      <Card>
        <CardHeader>
          <div className="flex items-center justify-between">
            <CardTitle>IP Strategy Deep Analysis</CardTitle>
            <ExpandableDetail
              title="Intellectual Property Strategy"
              value="6"
              unit="years exclusivity"
              assumptions={[
                "Core composition patents expire 2029 (5 years exclusivity)",
                "Method of use patents provide additional 1-2 years protection",
                "Regulatory exclusivity (orphan drug) adds 7 years from approval",
                "Trade secrets for manufacturing provide indefinite protection",
              ]}
              formula="Total Exclusivity = MAX(Patent Protection, Regulatory Exclusivity) + Trade Secret Value"
              sources={[
                { name: "Patent Analytics Platform", type: "database" },
                { name: "IP Law Firm Analysis", type: "manual" },
                { name: "Regulatory Exclusivity Database", type: "regulatory" },
              ]}
            />
          </div>
        </CardHeader>
