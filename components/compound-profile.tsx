...
export function CompoundProfile() {
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-lg">Mechanism of Action</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          <div>
            <h4 className="font-semibold text-sm text-slate-600 mb-2">Target Protein</h4>
            <p className="text-sm">EGFR L858R/T790M</p>
          </div>
          <div>
            <h4 className="font-semibold text-sm text-slate-600 mb-2">Pathway</h4>
            <p className="text-sm">EGFR/PI3K/AKT</p>
          </div>
          <div>
            <h4 className="font-semibold text-sm text-slate-600 mb-2">Description</h4>
            <p className="text-sm text-slate-700">
              Third-generation EGFR tyrosine kinase inhibitor designed to selectively target T790M resistance mutations
              while sparing wild-type EGFR, reducing skin and GI toxicity.
            </p>
          </div>
        </CardContent>
      </Card>
